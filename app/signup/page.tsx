...
import { Mail, User, ArrowRight, Leaf, Loader2, MailCheck } from "lucide-react"
...
export default function SignupPage() {
    ...
    const handleVerifyOtp = async (e: React.FormEvent) => {
        ...
        // Update profile upon successful signup verify because metadata trigger might be slow
        // But we rely on trigger for now. We can force update if needed.
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-fresh-50 via-white to-fresh-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
            ...
            <div className="absolute top-20 left-20 w-72 h-72 bg-fresh-200/30 dark:bg-fresh-500/10 rounded-full blur-3xl" />
            <div className="absolute bottom-20 right-20 w-96 h-96 bg-fresh-300/20 dark:bg-fresh-500/10 rounded-full blur-3xl" />
                        ...
                        <>
                            <div className="text-center mb-8">
                                ...
                                <p className="text-muted-foreground">
                                    Join Pureingo for fresh create daily
                                </p>
                            </div>
                            ...
                            <p className="text-center text-sm text-muted-foreground mt-6">
                                ...
                                <Link href="/login" className="text-fresh-600 hover:text-fresh-700 font-medium">
                                    Login
                                </Link>
                            </p>
                        </>
